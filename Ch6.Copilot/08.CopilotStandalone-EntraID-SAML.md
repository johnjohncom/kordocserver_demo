...
nav_order: 8
parent: 08. Copilot Standalone - EntraID와 SAML설정 가이드
---
...
설정시 필요한 값들은 아래와 같이 설정됩니다
   ...
   - 아래 <code>\<short code></code> 값은 신청폼에 기입해 주신 short code 값이며, 위 1번 과정에서 관리자 로그인시 나타나는 <code>\<your enterprise></code> 입니다.
   - Identifier : https://github.com/enterprises/<code>\<short code></code>
   - Reply URL : https://github.com/enterprises/<code>\<short code></code>/saml/consume
   - Sign-on URL : https://github.com/enterprises/<code>\<short code></code>/sso
...
### <3> Entra ID에서 SCIM 설정 : [Entra ID 설정 가이드](https://learn.microsoft.com/en-us/entra/identity/saas-apps/github-enterprise-managed-user-provisioning-tutorial)
