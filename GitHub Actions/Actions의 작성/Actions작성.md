...
### 1. 🎯 Actions 작성, 사용, 공유 
  ...
  - [현재 저장소에서 만들어진 Actions를 사용](https://docs.github.com/en/enterprise-server@latest/actions/learn-github-actions/finding-and-customizing-actions#referencing-an-action-in-the-same-repository-where-a-workflow-file-uses-the-action)하기 위해서는 아래 example과 같이 구성합니다. 
  ...
  - 만약 [Docker Hub에 컨테이너 이미지로 된 Actions를 사용](https://docs.github.com/en/enterprise-server@latest/actions/learn-github-actions/finding-and-customizing-actions#referencing-a-container-on-docker-hub)한다면 아래와 같이 지정합니다. 
  ...
  - 함께 사용할 Actions를 작성한다면, [별도의 저장소에 Actions를 만들고 공유하는 것이 좋습니다](https://docs.github.com/en/enterprise-server@latest/actions/creating-actions/about-actions#choosing-a-location-for-your-action). (Application등의 코드와 섞이지 않게)
  
  - 함께 사용할 Actions는 [release management를 하여 version tag을 통해](https://docs.github.com/en/enterprise-server@latest/actions/creating-actions/about-actions#good-practices-for-release-management) 사용하도록 하는 것이 좋습니다. 
...
### 2. Actions의 주요 features
  ...
  1. [Workflow내 Variable 사용](https://docs.github.com/en/enterprise-server@latest/actions/learn-github-actions/essential-features-of-github-actions#using-variables-in-your-workflows)
     ...
     - GitHub Actions는 [기본 환경 변수](https://docs.github.com/en/enterprise-server@latest/actions/reference/environment-variables#default-environment-variables)들을 가지고 있습니다.
  ...
  9. [Environment 사용](https://docs.github.com/en/enterprise-server@latest/actions/learn-github-actions/managing-complex-workflows#using-environments)
       ...
       - ['Environment'](https://docs.github.com/en/enterprise-server@latest/actions/reference/environments) 참조
...
### 4. Docker 컨테이너 Actions 📦
   ...
   - [Docker 컨테이너 actions 생성 방법 예시](https://docs.github.com/en/enterprise-server@latest/actions/creating-actions/creating-a-docker-container-action)
...
### 5. JavaScript Actions 📜
   ...
   - [JavaScript actions 생성 방법 예시](https://docs.github.com/en/enterprise-server@latest/actions/creating-actions/creating-a-javascript-action)
...
### 6. Composite run steps Actions
   ...
   - [Composite run step action 생성 방법 예시](https://docs.github.com/en/enterprise-server@latest/actions/creating-actions/creating-a-composite-run-steps-action)
